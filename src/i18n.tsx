...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "appSettings.agentProxyUrl": "Agent Proxy URL",
    "appSettings.agentProxyPlaceholder": "http://127.0.0.1:7890 or socks5://127.0.0.1:7890",
    "appSettings.agentProxyHint": "When set, Nezha exports this value to Claude Code and Codex as ALL_PROXY during internal launches.",
    "appSettings.agentProxySchemes": "Supported schemes: http, https, socks5, socks5h.",
    "appSettings.proxyErrorProtocol": "Use http://, https://, socks5://, or socks5h://",
    "appSettings.proxyErrorHostname": "Proxy URL must include a hostname",
    "appSettings.proxyErrorUrl": "Proxy URL must be a valid absolute URL",
  ...
  zh: {
    ...
    "appSettings.agentProxyUrl": "智能体代理 URL",
    "appSettings.agentProxyPlaceholder": "http://127.0.0.1:7890 或 socks5://127.0.0.1:7890",
    "appSettings.agentProxyHint": "设置后，Nezha 会在内部启动 Claude Code 和 Codex 时将该值导出为 ALL_PROXY。",
    "appSettings.agentProxySchemes": "支持协议：http、https、socks5、socks5h。",
    "appSettings.proxyErrorProtocol": "请使用 http://、https://、socks5:// 或 socks5h://",
    "appSettings.proxyErrorHostname": "代理 URL 必须包含主机名",
    "appSettings.proxyErrorUrl": "代理 URL 必须是有效的绝对 URL",
