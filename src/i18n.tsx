...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "appSettings.envVars": "Environment Variables",
    "appSettings.envVarsHint":
      "These variables are injected into Claude Code and Codex when each task starts. User-defined keys override Nezha's defaults (PATH, LANG, etc.). Values are stored in plain text in ~/.nezha/settings.json — avoid saving sensitive credentials in shared profiles.",
    "appSettings.envVarsKeyPlaceholder": "VARIABLE_NAME",
    "appSettings.envVarsValuePlaceholder": "value",
    "appSettings.envVarsAdd": "Add variable",
    "appSettings.envVarsRemove": "Remove",
    "appSettings.envVarsShow": "Show value",
    "appSettings.envVarsHide": "Hide value",
    "appSettings.envVarsInvalidKey": "Variable name must start with a letter or underscore and contain only letters, digits, or underscores.",
    "appSettings.envVarsDuplicateKey": "Another row uses the same variable name.",
    "appSettings.envVarsAutoSaveHint": "Changes are saved automatically. Restart any running tasks to pick up new values.",
  ...
  zh: {
    ...
    "appSettings.envVarsHint":
      "这些变量会在每次启动 Claude Code 与 Codex 任务时注入进去。同名变量会覆盖 Nezha 默认值（PATH、LANG 等）。注意：值以明文存储在 ~/.nezha/settings.json，请勿在共享设备上保存敏感凭据。",
    "appSettings.envVarsKeyPlaceholder": "变量名",
    "appSettings.envVarsValuePlaceholder": "值",
    "appSettings.envVarsAdd": "添加变量",
    "appSettings.envVarsRemove": "删除",
    "appSettings.envVarsShow": "显示值",
    "appSettings.envVarsHide": "隐藏值",
    "appSettings.envVarsInvalidKey": "变量名必须以字母或下划线开头，只能包含字母、数字、下划线。",
    "appSettings.envVarsDuplicateKey": "已有同名变量。",
    "appSettings.envVarsAutoSaveHint": "修改会自动保存。如需让运行中的任务生效，请重新启动它们。",
