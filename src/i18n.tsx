...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "appSettings.fontFamily": "Font Family",
    "appSettings.fontFamilyHint": "UI font for the interface. Leave as default to use the system font stack.",
    "appSettings.fontFamilyDefault": "Default",
    "appSettings.fontSize": "Font Size",
    "appSettings.fontSizeHint": "Base font size for the interface (10–24px). Leave as default for 13px.",
    "appSettings.fontSizeDefault": "Default (13px)",
    ...
    "session.attachSession": "Attach Session",
    "session.pickerTitle": "Select a Session",
    "session.noSessions": "No sessions found for this project.",
    ...
    "shortcut.deleteTask": "Delete Task",
    "shortcut.prevTask": "Previous Task",
    "shortcut.nextTask": "Next Task",
    "shortcut.toggleSidebar": "Toggle Sidebar",
    "shortcut.toggleFiles": "Toggle File Explorer",
    "shortcut.toggleGitChanges": "Toggle Git Changes",
    "shortcut.toggleGitHistory": "Toggle Git History",
    "shortcut.toggleTerminal": "Toggle Terminal",
    "shortcut.appSettings": "App Settings",
    "shortcut.projectSettings": "Project Settings",
    "shortcut.focusSearch": "Search Tasks",
    "shortcut.smartCopy": "Copy (Terminal)",
    "shortcut.sendMessage": "Send Message",
    "shortcut.pressKeys": "Press keys…",
    "shortcut.clickToEdit": "Click to change shortcut",
    "shortcut.reset": "Reset to default",
    "shortcut.group.task": "Tasks",
    "shortcut.group.panel": "Panels",
  ...
  zh: {
    ...
    "appSettings.fontFamily": "字体",
    "appSettings.fontFamilyHint": "界面 UI 字体。保持默认则使用系统字体。",
    "appSettings.fontFamilyDefault": "默认",
    "appSettings.fontSize": "字体大小",
    "appSettings.fontSizeHint": "界面基础字体大小（10–24px）。保持默认为 13px。",
    "appSettings.fontSizeDefault": "默认（13px）",
    ...
    "session.attachSession": "关联会话",
    "session.pickerTitle": "选择会话",
    "session.noSessions": "此项目没有找到会话。",
    ...
    "shortcut.deleteTask": "删除任务",
    "shortcut.prevTask": "上一个任务",
    "shortcut.nextTask": "下一个任务",
    "shortcut.toggleSidebar": "切换侧边栏",
    "shortcut.toggleFiles": "切换文件浏览器",
    "shortcut.toggleGitChanges": "切换 Git 变更",
    "shortcut.toggleGitHistory": "切换 Git 历史",
    "shortcut.toggleTerminal": "切换终端",
    "shortcut.appSettings": "应用设置",
    "shortcut.projectSettings": "项目设置",
    "shortcut.focusSearch": "搜索任务",
    "shortcut.smartCopy": "复制（终端）",
    "shortcut.sendMessage": "发送消息",
    "shortcut.pressKeys": "按下按键…",
    "shortcut.clickToEdit": "点击修改快捷键",
    "shortcut.reset": "恢复默认",
    "shortcut.group.task": "任务",
    "shortcut.group.panel": "面板",
    "shortcut.group.editor": "编辑器",
    "shortcut.group.terminal": "终端",
