...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "taskNotif.idle": "Output complete, awaiting reply",
    "taskNotif.inputRequired": "Needs attention",
    "taskNotif.fallbackTitle": "Task notification",
    "notif.masterToggle": "Enable Notifications",
    "notif.masterToggleDesc": "Turn off to suppress all task notifications",
    "notif.inAppToggle": "In-App Notifications",
    "notif.inAppToggleDesc": "Show toast popups within the app",
    "notif.systemToggle": "System Notifications",
    "notif.systemToggleDesc": "Show desktop notifications when the window is unfocused",
    "notif.soundToggle": "In-App Notification Sound",
    "notif.soundToggleDesc": "Play a sound for in-app task notification toasts",
    "notif.toastPosition": "Toast Position",
    "notif.typeFilterLabel": "Notification Types",
    "notif.typeDone": "Task completed",
    "notif.typeFailed": "Task failed",
    "notif.typeIdle": "Output complete, awaiting reply",
    "notif.typeInputRequired": "Needs attention",
  ...
  zh: {
    ...
    "taskNotif.idle": "输出完毕，待回复",
    "taskNotif.inputRequired": "需要处理",
    "taskNotif.fallbackTitle": "任务通知",
    "notif.masterToggle": "启用通知",
    "notif.masterToggleDesc": "关闭后所有任务通知将被静默",
    "notif.inAppToggle": "应用内通知",
    "notif.inAppToggleDesc": "在应用内显示 Toast 弹窗",
    "notif.systemToggle": "系统通知",
    "notif.systemToggleDesc": "窗口失焦时显示桌面通知",
    "notif.soundToggle": "应用内通知声音",
    "notif.soundToggleDesc": "应用内任务通知 Toast 出现时播放提示音",
    "notif.toastPosition": "Toast 位置",
    "notif.typeFilterLabel": "通知类型",
    "notif.typeDone": "任务完成",
    "notif.typeFailed": "任务失败",
    "notif.typeIdle": "输出完毕，待回复",
    "notif.typeInputRequired": "需要处理",
