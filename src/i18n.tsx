...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "appSettings.customWindowSize": "Remember Window Size",
    "appSettings.customWindowSizeEnabled": "Enabled",
    "appSettings.customWindowSizeDisabled": "Disabled",
    "appSettings.customWindowSizeHint": "When enabled, saves the current window size on close and restores it on next launch.",
  ...
  zh: {
    ...
    "appSettings.customWindowSize": "记住窗口大小",
    "appSettings.customWindowSizeEnabled": "已启用",
    "appSettings.customWindowSizeDisabled": "已禁用",
    "appSettings.customWindowSizeHint": "启用后，关闭程序时自动保存当前窗口大小，下次启动时恢复。",
