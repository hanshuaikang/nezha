...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "appSettings.wsl": "WSL",
    "appSettings.wslEnabled": "Enable WSL projects",
    "appSettings.wslDefaultDistro": "Default distro",
    "appSettings.wslDefaultShell": "Default shell",
    "appSettings.wslCheckDefault": "Check default distro",
    ...
    "settings.runtimeKind": "Runtime kind",
    "settings.runtimeLocal": "Local",
    "settings.linuxPath": "Linux path",
    "settings.uncPath": "Windows UNC path",
    "settings.checkRuntimeHealth": "Check health",
    "settings.runtimeHealthOk": "Available. Git: {git}",
    "settings.runtimeHealthFailed": "Runtime health check failed.",
    "settings.git": "Git",
    ...
    "welcome.openWslProject": "Open WSL Project",
    "welcome.openWslProjectHint": "Choose a distro and validate a Linux project path.",
    "welcome.wslDistro": "Distro",
    "welcome.wslLinuxPath": "Linux path",
    "welcome.wslLoadingDistros": "Loading WSL distros...",
    "welcome.wslMissingInput": "Choose a distro and enter a Linux path.",
    "welcome.wslValidateBeforeCreate": "Validate a writable WSL project path before creating it.",
    "welcome.wslValidate": "Validate",
    "welcome.wslValidating": "Validating...",
    "welcome.wslCreating": "Creating...",
    "welcome.wslCreateProject": "Create Project",
    "welcome.wslPathExists": "Path exists",
    "welcome.wslPathMissing": "Path does not exist",
    "welcome.wslPathWritable": "Writable",
    "welcome.wslPathNotWritable": "Not writable",
    "welcome.wslGitDetected": "Git repository detected",
    "welcome.wslGitMissing": "Git repository not detected",
    "welcome.local": "LOCAL",
    ...
    "newTask.wslWorktreeUnsupported": "WSL projects do not support task worktrees yet.",
  ...
  zh: {
    ...
    "appSettings.wsl": "WSL",
    "appSettings.wslEnabled": "启用 WSL 项目",
    "appSettings.wslDefaultDistro": "默认发行版",
    "appSettings.wslDefaultShell": "默认 Shell",
    "appSettings.wslCheckDefault": "检查默认发行版",
    ...
    "settings.runtimeKind": "运行环境类型",
    "settings.runtimeLocal": "本地",
    "settings.linuxPath": "Linux 路径",
    "settings.uncPath": "Windows UNC 路径",
    "settings.checkRuntimeHealth": "检查状态",
    "settings.runtimeHealthOk": "可用。Git：{git}",
    "settings.runtimeHealthFailed": "运行环境健康检查失败。",
    "settings.git": "Git",
    ...
    "welcome.openWslProject": "打开 WSL 项目",
    "welcome.openWslProjectHint": "选择发行版并校验 Linux 项目路径。",
    "welcome.wslDistro": "发行版",
    "welcome.wslLinuxPath": "Linux 路径",
    "welcome.wslLoadingDistros": "正在加载 WSL 发行版...",
    "welcome.wslMissingInput": "请选择发行版并输入 Linux 路径。",
    "welcome.wslValidateBeforeCreate": "创建前需要先校验一个可写的 WSL 项目路径。",
    "welcome.wslValidate": "校验",
    "welcome.wslValidating": "校验中...",
    "welcome.wslCreating": "创建中...",
    "welcome.wslCreateProject": "创建项目",
    "welcome.wslPathExists": "路径存在",
    "welcome.wslPathMissing": "路径不存在",
    "welcome.wslPathWritable": "可写",
    "welcome.wslPathNotWritable": "不可写",
    "welcome.wslGitDetected": "已检测到 Git 仓库",
    "welcome.wslGitMissing": "未检测到 Git 仓库",
    "welcome.local": "本地",
    ...
    "newTask.wslWorktreeUnsupported": "WSL 项目暂不支持任务工作树。",
