...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "theme.uiFontFamily": "UI Font",
    "theme.uiFontFamilyHint": "Font for interface text. Comma-separated for fallback.",
    "theme.monoFontFamily": "Code Font",
    "theme.monoFontFamilyHint": "Font for terminal, code blocks, and file viewer.",
    "common.reset": "Reset",
  ...
  zh: {
    ...
    "theme.terminalFontSize": "终端字体大小（10–20px，默认 12px）",
    "theme.terminalFontSizeHint": "仅调整终端面板中的字体大小，应用布局保持不变。",
    "theme.uiFontFamily": "UI 字体",
    "theme.uiFontFamilyHint": "界面文本使用的字体，多个字体用逗号分隔作为回退。",
    "theme.monoFontFamily": "代码字体",
    "theme.monoFontFamilyHint": "终端、代码块和文件查看器使用的字体。",
    "common.reset": "重置",
    "language.english": "English",
    "language.chinese": "中文",
    "settings.title": "设置",
