...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "appSettings.terminalAppearance": "Terminal Appearance",
    "appSettings.terminalFontFamily": "Font Family",
    "appSettings.terminalFontSize": "Font Size",
    "appSettings.terminalLineHeight": "Line Height",
    "appSettings.terminalAppearanceHint":
      "Applies to both embedded task terminals and shell terminals. Font family must exist on your system.",
  ...
  zh: {
    ...
    "appSettings.terminalAppearance": "终端显示",
    "appSettings.terminalFontFamily": "字体",
    "appSettings.terminalFontSize": "字号",
    "appSettings.terminalLineHeight": "行间距",
    "appSettings.terminalAppearanceHint": "同时作用于任务终端和 Shell 终端。字体名称需要是你系统里已安装的字体。",
