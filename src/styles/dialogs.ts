...
export const dialogs = {
  ...
  shortcutActionWarning: {
    fontSize: 11.5,
    lineHeight: 1.45,
    color: "var(--warning)",
  },
  shortcutActionControls: {
    display: "inline-flex",
    alignItems: "center",
    gap: 8,
    flexShrink: 0,
